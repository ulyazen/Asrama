						...
						<div class="col-lg-12 ">
							<div class="p-5">
								<div class="text-center">
									<h1 class="h4 text-gray-900 mb-4">Login Admin Website Asrama!</h1>
								</div>
								...
								<hr>
								<div class="text-center">
									<a class="small" href="<?= base_url('register') ?>">Belum memiliki akun? Daftar!</a>
									</br>
									<a class="small" href="<?= base_url('web') ?>">Kembali ke Website Asrama!</a>
								</div>
							</div>
						</div>
					</div>
